...
/**
 * The {@link FibaroAbstractSensorThingHandler} is responsible for handling commands, which are
 * sent to one of the channels.
 *
 * @author Johan Williams - Initial contribution
 */
public class FibaroAbstractSensorThingHandler extends FibaroAbstractThingHandler {

    private Logger logger = LoggerFactory.getLogger(FibaroAbstractSensorThingHandler.class);

    public FibaroAbstractSensorThingHandler(Thing thing) {
        super(thing);
    }
    ...
    public void init() throws FibaroConfigurationException {
        ...
        logger.debug("Initializing the sensor handler with id {}", id);
